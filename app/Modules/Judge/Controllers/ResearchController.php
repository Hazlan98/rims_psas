...
class ResearchController extends BaseController
{
    ...
    public function get_rp_dashboard($rp_event_id)
    {
        ...
        return redirect()->to(base_url('participant/rp_dashboard'));
    }
    ...
    public function rp_dashboard()
    {
        ...
        $research_papers = $this->rims_paper_info->where('rpi_owner_id', $user_id)->findAll();
        $data = [
    ...
    public function submitResearchPaper()
    {
        ...
        $rpi_data = [
            ...
            'rpi_status'            => 'Registered Successfully',
        ...
        if ($rpi_id) {
            ...
            foreach ($team_members as $member) {
                $team_data = [
                    'rrt_rpi_id' => $rpi_id,
                    'rrt_name'   => $member,
                    'rrt_role'   => 'member' // No presenter for drafts
                ];
    ...
    public function getRpiUpdateForm($rpi_id)
    {
        ...
        return redirect()->to(base_url('participant/rpi-update-form'));
    }
